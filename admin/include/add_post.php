...
<?php
    if(isset($_POST['adds_post']))
    {
        ...
        $query = "INSERT INTO posts(post_category_id,post_author,post_content,post_image,post_status,post_tags,post_title,post_date,post_author_id) VALUE ('$post_category','$post_author','$post_content','$post_image','$post_status','$post_tag','$post_title',now(),'$auth_id')";
...
<form action="" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <textarea id="editor_post"  class="form-control" name="content"></textarea>
    </div>
    <div class="form-group">
